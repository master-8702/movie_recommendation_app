...
class MovieEntity {
  ...
  final String? backdropPath; // cover image url
  ...
  @override
  int get hashCode {
    return title.hashCode ^ overview.hashCode ^ voteAverage.hashCode ^ genreIds.hashCode ^ releaseDate.hashCode ^ backdropPath.hashCode ^ posterPath.hashCode;
  }
